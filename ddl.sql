...
values(1,'Kratos','didaoure','Sokodé','986889','10','23','{Lundi Mardi Mercredi}','0.555','0.3666','En service');

Insert into restaurants(code,nom,adresse,ville,telephone,heure_ouverture,heure_fermeture,jour_ouverture,coordonnee_gps_x,coordonnee_gps_y,etat)
values(2,'LesPros','chaminade','Kara','794689','10','00','{Lundi Mardi Mercredi}','0.555','0.3666','En service');
