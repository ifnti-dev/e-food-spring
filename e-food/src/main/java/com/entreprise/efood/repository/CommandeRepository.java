...
public interface CommandeRepository  extends JpaRepository<Commande, Long>{
    ...
    @Query("SELECT new com.entreprise.efood.dtos.commandeDTO.RetrieveCmdDTO(cmd.montant,cmd.id,cmd.date_commande,cmd.client.user.nom,cmd.client.user.prenom,cmd.etat) FROM Commande cmd WHERE cmd.etat=:etat  ORDER BY cmd.date_commande ASC")
